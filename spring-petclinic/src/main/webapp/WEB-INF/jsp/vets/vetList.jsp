...
<div class="container">
    ...
    <table class="table-buttons">
        <tr>
            <td>
                <a href="<spring:url value="/vets.xml" htmlEscape="true" />"><fmt:message key="viewXml"/>View as XML</a>
            </td>
            <td>
                <a href="<spring:url value="/vets.atom" htmlEscape="true" />"><fmt:message key="subscribe"/></a>
            </td>
        </tr>
    </table>
